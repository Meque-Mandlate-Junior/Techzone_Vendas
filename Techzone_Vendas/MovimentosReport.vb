...
Public Class MovimentosReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Techzone_Vendas.MovimentosReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMovimentosReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MovimentosReport = New MovimentosReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
