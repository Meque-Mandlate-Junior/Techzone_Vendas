...
Public Class ReportLucros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Techzone_Vendas.ReportLucros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportLucros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportLucros = New ReportLucros()
        rpt.Site = Me.Site
        Return rpt
    End Function
